...
public class Tester {
	...
	public static void main(String[] args) throws IOException {
		...
		*/
		Users user = new Users("roger","123456","admin");
		FileManipulation.insert(user);
		ArrayList<Object> stu = FileManipulation.selectAll("Users.txt");
		for(int i=0;i<stu.size();i++) {
			Users local = (Users) stu.get(i);
